...
const adminRoutes = [
  ...
  <Route key="users-create" path="users/create"
    element={<ProtectedRoute role={["admin", "teacher"]}><UserCreate /></ProtectedRoute>} />,
  <Route key="users-id" path="users/:user_id"
    element={<ProtectedRoute role="admin"><UserDetail /></ProtectedRoute>} />,
  <Route key="users-edit" path="users/:user_id/edit"
    element={<ProtectedRoute role="admin"><UserEdit /></ProtectedRoute>} />,

  // Role management — /team4/roles
  <Route key="roles" path="roles"
    element={<ProtectedRoute role="admin"><RoleManagement /></ProtectedRoute>} />,
